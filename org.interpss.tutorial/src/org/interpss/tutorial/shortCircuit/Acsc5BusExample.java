...
public class Acsc5BusExample {
	...
	public static void main(String[] args) throws InterpssException {
		...
		System.out.println(faultNet.net2String());
	  	...
	  	//TODO  Core Engine implementation lib jar outdated
	  /*
	   * Exception in thread "main" java.lang.NoClassDefFoundError: com/interpss/core/acsc/fault/impl/AcscFaultResultImpl
	     at com.interpss.CoreObjectFactory.createAcscBusFault(CoreObjectFactory.java:1075)
	     at com.interpss.CoreObjectFactory.createAcscBusFault(CoreObjectFactory.java:1085)
	   */
